...
01_Raw_Data/: Dataset original en formato CSV proporcionado por ABC Corporation.

02_Data_Cleaning/: Documentación del proceso de transformación, gestión de nulos y estandarización.

03_Visual_Analytics/: Gráficos y dashboards que representan la correlación entre satisfacción, salario y rotación.
